...
const scenes = [
    // Verified: No setCurrentStep dependency
    {
        id: 1,
        ...
        content: (
            <div className="text-center text-white animate-in zoom-in duration-500">
                ...
                <h3 className="text-3xl md:text-5xl font-black mb-4 leading-tight">
                    Thủ tục BHXH <br />
                    <span className="opacity-90">quá rắc rối?</span>
                </h3>
                <p className="text-lg md:text-xl opacity-90 max-w-lg mx-auto">
                    Mất sổ, sai thông tin, chờ đợi mệt mỏi...
                </p>
            </div>
        )
    },
    {
        ...
        content: (
            <div className="text-center text-white animate-in slide-in-from-bottom duration-500">
                ...
                <h3 className="text-3xl md:text-5xl font-black mb-4 leading-tight">
                    Đã có giải pháp <br />
                    <span className="text-yellow-300">TRỌN GÓI 100%</span>
                </h3>
                <p className="text-lg md:text-xl opacity-90 max-w-lg mx-auto">
                    Xử lý nhanh chóng - Đúng luật 2025 - Không cần đi lại
                </p>
            </div>
        )
    },
    {
        ...
        content: (
            <div className="text-center text-white animate-in fade-in duration-700">
                ...
                <p className="text-xl">Đánh giá 5/5 sao về chất lượng</p>
            </div>
        )
    },
    {
        ...
        content: (
            <div className="text-center text-slate-900 animate-in zoom-in duration-500">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-slate-500 font-medium">Hỗ trợ 24/7 qua Zalo & Điện thoại</p>
                </div>
            </div>
        )
    }
