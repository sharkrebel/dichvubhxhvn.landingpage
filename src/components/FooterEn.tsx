            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Specializing in Social Insurance consulting with 15+ years of experience.
                            Handling all cases from simple to complex for Expats & locals.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm text-gray-400">Partner Website</p>
                                    <a
                ...
                <div className="mt-12 pt-8 border-t border-white/10">
                    ...
                    <p className="mt-6 text-xs text-gray-500 text-center leading-relaxed max-w-4xl mx-auto">
                        DichVuBHXH.vn is an independent consulting service provider, assisting clients
                        with administrative procedures under civil authorization. We are NOT a State Social Insurance
                        Agency and do not impersonate government agencies. All benefit decisions are approved by
                        competent Social Insurance authorities.
                    </p>
                </div>
            </div>
        </footer>
