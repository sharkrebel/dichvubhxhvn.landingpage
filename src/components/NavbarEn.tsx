...
const menuItems = [
    { name: "Home", href: "/en" },
    {
        ...
        submenu: [
            ...
            { name: "Foreigner Service", href: "/en/services/foreigner" },
            { name: "Profile Completion", href: "/en/services/profile-completion" },
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden lg:flex items-center gap-1">
                        ...
                        {/* Updated External Link - Online Tools Dropdown */}
                        <div
                            className="relative"
                        ...
                        >
                            ...
                            {activeDropdown === "online-tools" && (
                                <div className="absolute top-full left-0 pt-2 w-72 z-50 animate-enter origin-top-left">
                                    <div className="bg-white dark:bg-[#1e293b] rounded-xl shadow-xl border border-[var(--border)] py-2">
                                        <a
                                        ...
                                        >
                                            <span>Calculate 1-time Social Insurance</span>
                                        ...
                                        <a
                                            ...
                                            className="flex items-center justify-between px-4 py-2.5 text-sm text-[var(--foreground)] hover:bg-[var(--primary)]/10 hover:text-[var(--primary)] transition-colors"
                                        >
                                            <span>Expected Pension Calculation</span>
                                            <svg className="w-3.5 h-3.5 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                            </svg>
                                        </a>
