...
const services = [
  {
    ...
    description: "Hỗ trợ thủ tục rút BHXH 1 lần cho người lao động VN, đúng luật 2025",
...
const reasons = [
  ...
  },
  {
    number: "24/7",
    label: "Hỗ trợ",
    description: "Tư vấn qua Zalo, điện thoại mọi lúc",
  },
  {
    number: "Toàn quốc",
    label: "Phạm vi",
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--primary)]/10 text-[var(--primary)] rounded-full text-sm font-medium">
            ...
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-[#1e293b] rounded-3xl shadow-2xl p-8 border border-[var(--border)]">
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold">Xử lý nhanh chóng</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold">Đúng luật 2025</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold">Hoàn phí 100%</p>
